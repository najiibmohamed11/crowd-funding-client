...
const CampaignInfoCard = () => {
  ...
  const campaignUrl = "https://example.com/campaign/powered-kits-learning-boxes"
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-baseline justify-between">
              <span className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-blue-500 dark:from-green-400 dark:to-blue-500">1.9 ETH</span>
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
                raised of 2.0 ETH goal
              </span>
            </div>
            <Progress
              value={95}
 ...
 size="lg" variant="outline" className="bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <p className="font-medium text-gray-900 dark:text-gray-300">{donator.name}</p>
        ...
        <div className="mt-6 text-center">
          <Button onClick={()=>setIsDonateListOpen(true)} variant="outline" className="bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
